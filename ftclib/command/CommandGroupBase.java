 ...
 * @author Jackson
 */
public abstract class CommandGroupBase extends CommandBase implements CommandInterface {

    private static final Set<Command> m_groupedCommands =
            Collections.newSetFromMap(new WeakHashMap<Command,java.lang.Boolean>());
