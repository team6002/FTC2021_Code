...
public class MotorEx extends Motor {
     ...
     */
    public MotorEx(HardwareMap hMap, String id, GoBILDA gobildaType) {
     ...
     */
    public MotorEx(HardwareMap hMap, String id, double cpr, double rpm) {
    ...
    public void set(double output) {
        if (runmode == RunMode.VelocityControl) {
            ...
            double velocity = veloController.calculate(super.getVelocity(), speed) + feedforward.calculate(speed);
