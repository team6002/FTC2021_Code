 ...
 */
public class Odometry_UpdByOpenCvVuforia extends CommandBase {

    private ElapsedTime m_runtime = new ElapsedTime();
    private final Odometry m_Odometry;
    private final SUB_OpenCvAlongVuforia m_VuforiaNav;
    private LED m_LED;
    ...
    public Odometry_UpdByOpenCvVuforia(Odometry p_odometry, SUB_OpenCvAlongVuforia p_VuforiaNav) {
    ...
    public Odometry_UpdByOpenCvVuforia led(LED led) {
        m_LED = led;
        return this;
    }
    ...
    public Odometry_UpdByOpenCvVuforia ledColor(RevBlinkinLedDriver.BlinkinPattern color) {
        m_ledColor = color;
        return this;
    }

    public Odometry_UpdByOpenCvVuforia maxTime(double maxTime) {
        m_Maxtime = maxTime;
        return this;
    }
    ...
    public Odometry_UpdByOpenCvVuforia shouldBeClose(boolean close) {
    ...
    // is used.
    public Odometry_UpdByOpenCvVuforia numSimilar(int number) {
        m_numSimilar = number;
        return this;
    }
