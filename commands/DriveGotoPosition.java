...
public class DriveGotoPosition extends CommandBase {
...
//    private double m_distanceToAccelerate = 3; // inches to max speed
    ...
    public DriveGotoPosition(BaseRobot baseRobot, double targetX, double targetY) {
    ...
    public DriveGotoPosition(Drivetrain drivetrain, Odometry odometry,
                                 double targetX, double targetY) {
        this(odometry.m_baseRobot, targetX, targetY);
    }

    public DriveGotoPosition decel(double distance) {
        m_distanceToDecelerate = distance;
        return this;
    }

    public DriveGotoPosition timeout(double timeout) {
        m_timeout = timeout;
        return this;
    }

    // Same as above but with a longer, more descriptive name.
    public DriveGotoPosition decelDistance(double distance) {
        return decel(distance);
    }

    public DriveGotoPosition angle(double angle) {
        m_preferredAngle = Math.toRadians(angle);
        m_usePreferredAngle = true;
        return this;
    }

    public DriveGotoPosition posBuffer(double buffer) {
        m_positionBufferX = buffer;
        m_positionBufferY = buffer;
        return this;
    }

    public DriveGotoPosition posBufferX(double buffer) {
        m_positionBufferX = buffer;
        return this;
    }

    public DriveGotoPosition posBufferY(double buffer) {
        m_positionBufferY = buffer;
        return this;
    }

    public DriveGotoPosition angleBuffer(double buffer) {
        m_rotationBuffer = buffer;
        return this;
    }

    public DriveGotoPosition speed(double speed) {
        m_maxSpeed = speed;
        return this;
    }

    public DriveGotoPosition minSpeed(double speed) {
        m_minSpeed = speed;
        return this;
    }

    public DriveGotoPosition turnSpeed(double speed) {
        m_turnSpeed = speed;
        return this;
    }
