...
public class CMD_TEA_SetStateScoreRelease extends SequentialCommandGroup {
    private final FSM_TeamElementArm m_FSM;

    public CMD_TEA_SetStateScoreRelease(FSM_TeamElementArm p_FSM
        , SUB_TEA_elbow p_elbow, SUB_TEA_wrist p_wrist, SUB_TEA_claw p_claw) 
    {
        ...
        addCommands (
            ...
            , new CMD_TEA_SetState(p_FSM, FSM_TeamElementArm.State.SCORE_RELEASE)
        );
    }
}
